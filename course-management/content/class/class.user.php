					...
					<div class="col-md-4 col-xs-12 pull-right">
						<form class="login-form" method="get" autocomplete="off">
							...
							<div class="form-group">
								<label for="user_name"><?php _e('User name');?>&nbsp;<span class="required">*</span></label>
								<input type="text" name="user_name" class="form-control input-sm" placeholder=""/>
							</div>
							<div class="form-group">
								<label for="user_pass"><?php _e('Password');?>&nbsp;<span class="required">*</span></label>
							...
							<div class="form-group">
								...
								<button class="btn btn-block btn-success btn-sm" type="submit"><i class="fa fa-lock"></i>&nbsp;<?php _e('Login');?></button>
							</div>
							<div class="form-group">
					...
					<div class="modal-content">
						...
						<form class="upload-profile-image" method="post" autocomplete="off">
							<div class="modal-body">
								...
								<div class="form-group">
									<div class="alert alert-success"><i class="fa fa-circle-o-notch fa-spin" aria-hidden="true"></i>&nbsp;<?php _e('Image is being upload, please do not close upload box ..');?></div>
								</div>
							</div>
								...
								<?php if($notifications__result):
									...
									<li>
										...
										<div class="message_date">
											...
											<p class="month"><?php echo date('M',strtotime($user__notifications->date));?></p>
										</div>
			...
			elseif(!$user):
				...
				<div class="col-md-3 col-sm-3 col-xs-12 profile_left">
					...
					<ul class="list-unstyled user_data">
						...
						<li><i class="fa fa-phone"></i>&nsbp;<?php echo get_user_meta($user->ID,'user_phone',true);?></li>
						<?php endif; ?>
			...
			if(!user_can('add_user')):
				...
				<form class="add-user user-form" method="post" autocomplete="off">
					...
					<div class="row">
						...
						<div class="form-group col-sm-6 col-xs-12">
							<label for="dob"><?php _e('Date of birth');?>
							</label>
