				...
				<table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap datatable-buttons" cellspacing="0" width="100%">
					...
					<tbody>
						...
						<tr>
							...
							<td>	
								<label><input type="checkbox" class="js-switch" <?php checked($course->active, 1);?> onClick="javascript:approve_switch(this);" data-id="<?php echo $course->ID;?>" data-action="course_approve_change"/></label>
							</td>
