		...
		if($data_list):
			foreach($data_list as $booking):
				...
				<div class="text-center">
					...
					<button type="button" class="btn btn-success btn-xs view-nurses" data-toggle="modal" data-target="#nurse-data-modal" data-booking="<?php echo $booking->ID;?>" onclick="get_nurses(this);">
					...
					<button type="button" class="btn btn-danger btn-xs" onclick="javascript:delete_function(this);" data-id="<?php echo $booking->ID;?>" data-action="delete_booking">
	...
	public function fetch__booking__nurses__process(){
		...
		if($booking):
			...
			if(!empty($nurses)):
				...
				<button type="button" class="btn btn-info btn-xs additional-information" data-toggle="modal" data-target="#additional-information-data-modal" data-booking="<?php echo$booking->ID;?>" onclick="get_additional_information(this);">
				...
				<table class="table table-striped table-condensed table-bordered" style="margin-bottom: 0px;">
					...
					<tbody>
						...
						<tr>
							...
							<td><label><input type="checkbox" class="js-switch" <?php if(isset($attendance[$nurse] )) checked($attendance[$nurse] , 1);?> onclick="javascript:nurse_modal_approve_switch(this);" data-booking="<?php echo $booking_id;?>" data-user="<?php echo $nurse;?>" data-action="attendance"/></label></td>
							<td><label><input type="checkbox" class="js-switch" <?php if(isset($enroll[$nurse])) checked($enroll[$nurse] , 1);?> onclick="javascript:nurse_modal_approve_switch(this);" data-booking="<?php echo $booking_id;?>" data-user="<?php echo $nurse;?>" data-action="complete"/></label></td>
							<td><label><input type="button" value="Send" class="btn btn-dark btn-xs" <?php if(isset($enroll[$nurse])) checked($enroll[$nurse] , 1);?> onclick="javascript:nurse_modal_approve_switch(this);" data-booking="<?php echo $booking_id;?>" data-user="<?php echo $nurse;?>" data-action="reminder"/></label></td>
							<td><label><button type="button" class="btn btn-danger btn-xs" onclick="javascript:nurse_remove_switch(this);" data-booking="<?php echo $booking_id;?>" data-user="<?php echo $nurse;?>"><?php _e('Remove');?></button></label></td>
						</tr>
						<?php endforeach; ?>
					</tbody>
				</table>
	...
	public function fetch__booking__additional__information__process(){
		...
		if($booking):
			...
			if(!empty($nurses)):
				...
				<button type="button" class="btn btn-info btn-xs view-nurses" data-toggle="modal" data-target="#nurse-data-modal" data-booking="<?php echo $booking->ID;?>" onclick="get_nurses(this);">
				...
				<table class="table table-striped table-condensed table-bordered" style="margin-bottom: 0px;">
					...
					<tbody>
						...
						<tr>
							...
							<td><label><input type="checkbox" class="js-switch" <?php if(isset($collected[$nurse])) checked($collected[$nurse] , 1);?> onclick="javascript:nurse_modal_approve_switch(this);" data-booking="<?php echo $booking_id;?>" data-user="<?php echo $nurse;?>" data-action="collected"/></label></td>
